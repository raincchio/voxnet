...
runs_1 = [pd.read_csv('loss/' + x) for x in os.listdir('loss')]
...
sns.lineplot(x='Step', y='smooth', data=runs_1[0], label='DenseVoxNet')
sns.lineplot(x='Step', y='smooth', data=runs_1[1], label='SparseVoxNet')
sns.lineplot(x='Step', y='smooth', data=runs_1[2], label='SparseVoxNet-D')
...
# plt.show()
plt.savefig('figures/baseline2.png', bbox_inches='tight')