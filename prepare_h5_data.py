...
def prepare_h5_data(data_folder, h5_save_folder, **kwargs):
    ...
    if len(kwargs) < 3:
        ...
        h5_train_list = "./train.txt"
        h5_test_list = "./test.txt"

    if not os.path.exists(h5_save_folder):
        os.mkdir(h5_save_folder)

    fid_train = open(h5_train_list, 'w')
    fid_test = open(h5_test_list, 'w')
...
if __name__ == '__main__':
    prepare_h5_data(data_folder='/data', h5_save_folder='/h5_data')
